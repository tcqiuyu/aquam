...
var node_1 = new joint.shapes.custom.ElementLink({
    ...
    attrs: {
        rect: {fill: '#2D69A6'},
        a: {"href": '#water-use-analyzer', 'xlink:show': 'new', cursor: 'pointer', target: '_self'},
...
node_2.attr({
    a: {"href": '#water-quality-analyzer', target: '_self'},
    text: {text: '  Drilling/\nFracturing'}
});
...
node_4.attr({
    a: {"href": '#produced-water-modeler', target: '_self'},
    text: {text: '    Produced\nWater Storage'}
});
...
node_5.attr({
    rect: {fill: '#2D69A6'},
    a: {"href": '#water-treatment-analyzer', 'cursor': 'pointer', target: '_self'},
    text: {text: 'Treatment'}
});
