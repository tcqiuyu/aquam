...
def import_data(excel_file):
    ...
    for row in range(1, nrows):
        ...
        sql = 'INSERT INTO solutions_wateruse (api, frac_date, state, county, operator, well_name, latitude, longtitude, datum, well_trajectory, horizontal_length, water_use) \
               VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);'
        try:
            vals = [api, frac_date, state, county, operator, well_name, latitude, longtitude, datum, well_trajectory, horizontal_length, water_use]
...
if __name__ == '__main__':
    excel_file = 'D:/Github/aquam/data_input/water_use.xls'
